    ...
    public partial class UCS : UserControl
    {
        ...
        public void ucsTraversal()
        {
            try
            {
                ...
                pq.Enqueue(new Tuple<int, int>(s, 0));  
                prevNode[s] = s;
                distance[s] = 0; 
                ...
                while (pq.Count != 0)
                {
                    ...
                    //lblVisited.Text += visited.Peek().Item1.ToString() + " ";
            ...
            {
                MessageBox.Show("Invalid Traversal Inputs!", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
